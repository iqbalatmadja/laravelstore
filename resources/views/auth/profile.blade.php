...
<div class="position-absolute top-50 start-50 translate-middle mt-5 w-25 p-3 col-auto bg-light border border-secondary border-2 m-2 rounded-4">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="Type Your Name | Max 32 chars " maxlength="32" autocomplete="off" value="{{ $user->name }}">
        @if ($errors->has('name'))
    ...
    <div class="mb-3">
        ...
        <input type="email" class="form-control" id="" name="" value="{{ $user->email }}" readonly>
    </div>
    <div class="mb-3">
